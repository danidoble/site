    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="max-w-md w-full space-y-8 bg-white p-6 rounded-md shadow-md">
            ...
            <form class="mt-8 space-y-6" action="<?= route('forgot-password') ?>" method="POST">
                <?= csrf('forgot-password') ?>
                <div class="rounded-md shadow-sm -space-y-px text-xs text-gray-600">
                    <?=__('If you lost your password, write your email below and we send a message to start the process of recovery.')?>
                </div>
